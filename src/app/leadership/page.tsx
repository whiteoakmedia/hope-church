...
import { staffPageQuery, staffQuery } from "@/sanity/queries";
import type { StaffPage, Staff } from "@/sanity/types";
...
export default async function LeadershipPage() {
  const [staffPage, staff] = await Promise.all([
    client.fetch<StaffPage | null>(staffPageQuery),
    client.fetch<Staff[] | null>(staffQuery),
  ]);

  const heroHeading =
    staffPage?.heroHeading || "Leadership";
  const heroSubheading =
    staffPage?.heroSubheading ||
    "Meet the people leading and serving at Hope Christian Church.";
  ...
  return (
    <div className="bg-bg min-h-screen">
      ...
      {hasStaff ? (
              ...
              {staff.map((member, index) => (
                ...
                >
                  ...
                  >
                    ...
                    {member.bio && (
                      <div className="space-y-5 text-text-muted body-lg prose prose-lg max-w-none">
        ...
        /* ---- Hardcoded fallback: Pastor Jim & Sharon ---- */
        <section className="section-padding section-padding-y">
          <div className="container-wide">
      ...
      {/* ---- Favorite Passage (always shown, hardcoded) ---- */}
      {hasStaff && (
        <section className="section-padding pb-20">
          <div className="container-wide max-w-3xl">
            <div className="bg-white rounded-2xl p-8 shadow-[0_2px_20px_rgba(26,35,50,0.06)] border border-bg-alt">
              <span className="text-accent text-[0.75rem] font-semibold tracking-[0.15em] uppercase block mb-3">
                Their Favorite Passage
              </span>
              <blockquote className="border-l-4 border-accent pl-6">
